  ...
  return (
    <>
      ...
      <p className="text-amber-300 text-sm bg-amber-900/20 border border-amber-700 rounded p-3 my-3">
        <b>Framing note:</b> These scripts position you as a <i>team contributor</i> with concrete <i>module ownership</i> at 1Finance — not as the architect of the whole 1Finance website platform. That keeps your story honest and resilient under technical depth questioning.
      </p>

      <h2>The 60-Second Script (Most Common)</h2>
      <Card>
        <p>&quot;Hi, I&apos;m Arvind Sharma, a full-stack engineer with over five years of experience, currently building fintech APIs at 1Finance through NeoSOFT Technologies.</p>
        <p>I work as part of the 1Finance website team. We have a Go-and-Fiber API layer with around 30 feature namespaces, and I own several of them end-to-end — Magazine registrations and exports, the In-the-News admin pipeline with publish toggles and snapshot refresh, HR Conclave registrations and the speaker cards, Master Class events with OTP-based enrollment, and the QFA financial-advisor module.</p>
        <p>Before 1Finance I built WooCommerce platforms with payment gateway integration at Thinkbar, and responsive WordPress sites at Visualytes — so I&apos;ve worked across the stack from PHP plugins to modern Go services to Next.js frontends.</p>
      ...
      <Card>
        <p>&quot;Hi, I&apos;m Arvind. I&apos;m a full-stack engineer based in Mumbai, with five-plus years building production-grade financial systems and scalable APIs.</p>
        <p>I&apos;ve been at 1Finance through NeoSOFT since January 2023. I&apos;m a contributor on the 1Finance website platform — it&apos;s a Go/Fiber API platform with around 30 feature modules powering the 1Finance product. I don&apos;t own the whole platform, but I do own several modules end-to-end:</p>
        <ul>
        ...
        <p>Before 1Finance I built WooCommerce platforms with payment gateway integration at Thinkbar, and WordPress sites at Visualytes. I&apos;m looking for a full-stack role with significant Go and Next.js work where I can grow into wider architectural ownership.&quot;</p>
      </Card>

      <h2>The 2-Minute Script (Walkthrough Style)</h2>
      <details>
        <summary>Click to expand</summary>
        <p><b>Opening (15s):</b> &quot;Hi, I&apos;m Arvind Sharma — full-stack engineer with 5+ years, currently at 1Finance through NeoSOFT.&quot;</p>
        <p><b>Current scope (50s):</b> &quot;I&apos;m a team contributor on the 1Finance website Go/Fiber platform. The platform has ~30 namespaces; I personally own several modules end-to-end. The biggest are Magazine (registrations, CSV export, encryption backfill of legacy data), In-the-News (landing, archive, admin publish/snapshot pipeline), HR Conclave (registrations + speaker cards with rich text + nominees), Master Class (events, OTP enrollment, audio/video delivery), QFA (qualified financial advisor CRUD + search), and App Reviews. I also work on header search with click/abandon tracking, sitemap generators for our financial product pages, and CSV bulk imports for mutual funds, health insurance, credit cards, and NPS data.&quot;</p>
        ...
        <p><b>Past experience (20s):</b> &quot;Before this I built WooCommerce platforms with payment gateway integration at Thinkbar, and WordPress sites at Visualytes. Early work taught me to talk to clients directly and translate vague needs into shipped features.&quot;</p>
      ...
      <details><summary>Founder / CTO interview (smaller companies)</summary>
        <p>Lead with product impact and what you ship. Mention you&apos;ve worked directly with clients (Visualytes). Show you can own features end-to-end across the full stack.</p>
      </details>
